...
#include <iomanip>
  ...
  void printTree(ft::RBT t) {
	...
	void	real_print(ft::RBTset<ft::set<int>::key_type, ft::set<int>::key_compare>::Node<int> *ptr, int space, ft::RBTset<ft::set<int>::key_type, ft::set<int>::key_compare> test)
	{
...
int	main(void)
{
	...
	real_print(M._tree.getRoot(), 0, M._tree);*/
/*	M._tree.insertNode(ft::make_pair(1, 1));
	M._tree.insertNode(ft::make_pair(2, 2));
	M._tree.insertNode(ft::make_pair(3, 3));
	M._tree.insertNode(ft::make_pair(4, 4));
	M._tree.insertNode(ft::make_pair(5, 5));
	M._tree.insertNode(ft::make_pair(6, 6));
	real_print(M._tree.getRoot(), 0, M._tree);
